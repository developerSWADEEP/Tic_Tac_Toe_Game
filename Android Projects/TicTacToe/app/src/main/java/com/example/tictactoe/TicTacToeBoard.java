...
public class TicTacToeBoard extends View
{
    ...
    public TicTacToeBoard(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray arr = context.getTheme().obtainStyledAttributes(attrs, R.styleable.TicTacToeBoard,
                0, 0);
        ...
        try
        {
            ...
            winningLineColor = arr.getInteger(R.styleable.TicTacToeBoard_winningLineColor, 0);
        }
        finally
        {
            arr.recycle();
    ...
    private void drawPtiveDiagonalWinLine(Canvas canvas)
    {
        canvas.drawLine(0,cellSize*3,cellSize*3,0, paint);
    }

    private void drawNtiveDiagonalWinLine(Canvas canvas)
    {
    ...
    private void drawwinLine(Canvas canvas)
    {
        ...
        switch (game.getWinType() [2])
        {
            ...
            case 2:
                ...
                break;
            case 3:
                drawNtiveDiagonalWinLine(canvas);
                break;
            case 4:
                drawPtiveDiagonalWinLine(canvas);
                break;
        }
    }
